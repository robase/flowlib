...
Start your server and visit `http://localhost:3000/flowlib`. You should see the Flowlib dashboard where you can create and run flows.

## Add the visual editor (optional)

If your frontend is a separate React app, install `@flowlib/ui` and mount the editor:
