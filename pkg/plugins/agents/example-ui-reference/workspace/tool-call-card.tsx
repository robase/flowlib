...
function toolIcon(name: string) {
  ...
  if (name.startsWith("skills")) return BookOpen
  if (name === "write_file") return FileEdit
  if (name === "read_file") return FileText
  if (name === "delete_file") return Trash2
  if (name === "run_shell") return Terminal
  return Wrench
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="min-w-0 flex-1 truncate font-mono text-xs text-muted-foreground">{argText}</span>
