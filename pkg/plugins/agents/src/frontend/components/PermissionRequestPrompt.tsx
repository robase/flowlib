...
export const PermissionRequestPrompt: React.FC<PermissionRequestPromptProps> = ({
  ...
  return (
    <div
      className="rounded border border-warning bg-warning/10 px-3 py-2 my-2"
      role="alertdialog"
    ...
    >
      ...
      <div className="flex items-center gap-2 mt-2">
        ...
        <button
          type="button"
          className="px-3 py-1 rounded bg-destructive text-primary-foreground text-sm hover:bg-destructive/90 disabled:opacity-50"
          disabled={isResolved}
          onClick={() => handle('deny')}
        >
