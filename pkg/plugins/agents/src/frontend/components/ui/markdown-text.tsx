...
const proseClass = cn(
  ...
  'prose-pre:my-2 prose-pre:bg-muted/40 prose-pre:text-foreground prose-pre:rounded-md prose-pre:p-3 prose-pre:text-xs prose-pre:overflow-x-auto',
  'prose-code:bg-muted/40 prose-code:text-foreground prose-code:rounded prose-code:px-1 prose-code:py-0.5 prose-code:text-xs prose-code:before:content-none prose-code:after:content-none',
