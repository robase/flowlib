...
export function generateSqliteSchema(schema: MergedSchema): string {
  ...
  // Header
  lines.push(`// SQLite schema for Invect — AUTO-GENERATED by @flowlib/cli`);
...
export function generatePostgresSchema(schema: MergedSchema): string {
  ...
  // Header
  lines.push(`// PostgreSQL schema for Invect — AUTO-GENERATED by @flowlib/cli`);
  lines.push(`// Do not edit manually. Run \`npx flowlib-cli generate\` to regenerate.`);
  lines.push(``);
  lines.push(`import {`);
  lines.push(`  pgTable,`);
...
export function generateMysqlSchema(schema: MergedSchema): string {
  ...
  // Header
  lines.push(`// MySQL schema for Invect — AUTO-GENERATED by @flowlib/cli`);
  lines.push(`// Do not edit manually. Run \`npx flowlib-cli generate\` to regenerate.`);
  lines.push(``);
  lines.push(`import {`);
...
export function generateSqliteSchemaAppend(schema: MergedSchema): AppendSchemaResult {
  ...
  lines.push(``);
  lines.push(`// =============================================================================`);
  lines.push(`// Invect tables — AUTO-GENERATED by @flowlib/cli`);
...
export function generateSqliteRawSql(schema: MergedSchema): string {
  const lines: string[] = [];
  lines.push(`-- SQLite migration for Invect — AUTO-GENERATED by @flowlib/cli`);
...
export function generatePostgresRawSql(schema: MergedSchema): string {
  const lines: string[] = [];
  lines.push(`-- PostgreSQL migration for Invect — AUTO-GENERATED by @flowlib/cli`);
...
export function generateMysqlRawSql(schema: MergedSchema): string {
  const lines: string[] = [];
  lines.push(`-- MySQL migration for Invect — AUTO-GENERATED by @flowlib/cli`);
