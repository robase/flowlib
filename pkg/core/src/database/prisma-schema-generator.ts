...
export function generateFullPrismaSchema(schema: MergedSchema, provider: PrismaProvider): string {
  ...
  // Header
  lines.push(`// Prisma schema for Invect — AUTO-GENERATED by @flowlib/cli`);
  lines.push(
    `// Do not edit the Invect models manually. Run \`npx flowlib-cli generate\` to regenerate.`,
  );
  lines.push(``);
...
export function generatePrismaModels(schema: MergedSchema, provider: PrismaProvider): string {
  ...
  lines.push(``);
  lines.push(`// =============================================================================`);
  lines.push(`// Invect Models — AUTO-GENERATED by @flowlib/cli`);
  lines.push(
