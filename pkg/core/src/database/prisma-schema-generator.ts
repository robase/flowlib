...
export function generateFullPrismaSchema(schema: MergedSchema, provider: PrismaProvider): string {
  ...
  // Header
  lines.push(`// Prisma schema for Flowlib — AUTO-GENERATED by @flowlib/cli`);
  lines.push(
    `// Do not edit the Flowlib models manually. Run \`npx flowlib-cli generate\` to regenerate.`,
  );
  lines.push(``);
 ...
 *
 * Useful when adding Flowlib models to an existing Prisma schema.
 */
export function generatePrismaModels(schema: MergedSchema, provider: PrismaProvider): string {
  ...
  lines.push(``);
  lines.push(`// =============================================================================`);
  lines.push(`// Flowlib Models — AUTO-GENERATED by @flowlib/cli`);
  lines.push(
    `// Do not edit these models manually. Run \`npx flowlib-cli generate\` to regenerate.`,
  );
  lines.push(`// =============================================================================`);
  lines.push(``);
