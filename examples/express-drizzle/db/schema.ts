...
// =============================================================================
// Invect tables — AUTO-GENERATED by @flowlib/cli
...
export const twoFactor = sqliteTable('invect_two_factor', {
  id: text('id').primaryKey().notNull(),
  userId: text('user_id')
    .notNull()
    .references(() => user.id, { onDelete: 'cascade' }),
...
export const vc_sync_config = sqliteTable('invect_vc_sync_config', {
  id: text('id').primaryKey().notNull(),
  flowId: text('flow_id')
    .notNull()
    .unique()
...
export const vc_sync_history = sqliteTable('invect_vc_sync_history', {
  id: text('id')
    .primaryKey()
    .notNull()
    .$defaultFn(() => randomUUID()),
