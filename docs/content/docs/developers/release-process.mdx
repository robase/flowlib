...
Invect is a monorepo of `@flowlib/*` packages published to npm. Releases are automated via [Changesets](https://github.com/changesets/changesets) and GitHub Actions.
